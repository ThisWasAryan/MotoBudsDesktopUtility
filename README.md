...
- **Separation of Concerns**: Please note that the actual source code for the desktop application resides on the `main` branch. This `gh-pages` branch is completely independent and should not contain application code.
